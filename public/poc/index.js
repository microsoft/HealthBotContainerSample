...
function disableButtons(targetButton) {
    if (!targetButton.classList.contains("ac-pushButton") && targetButton.parentElement.classList.contains("ac-pushButton")) {
    ...
    for (let i = 0; i < allChildren.length; i++) {
        if (allChildren[i].innerText) {
            ...
            allChildren[i].removeEventListener("click", optionSelected);
...
function disableButtonsAfterClick() {
    setInterval(function () {
        // remove all buttons except the selected one, change their color, and make unclickable
