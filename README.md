...
**Note:** In order to use this Web Chat with the Health Bot service, you will need to obtain your Web Chat secret by going to ["Integration/Channels/WebChat"](./secrets.png) on the navigation panel.
